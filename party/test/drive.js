...
const FAST = { mothlight:'ml_fast=1', firefly:'ff_fast=1', liftingfog:'lf_fast=1', firstfrost:'fr_fast=1', moongraft:'mg_fast=1', samesoil:'ss_fast=1', widemargin:'wm_fast=1', bearing:'br_fast=1', understudy:'us_fast=1' };
...
(async () => {
  ...
  while (Date.now() < DEADLINE) {
    ...
    await host.evaluate(() => {
      ['ml-next','ff-next','lf-next','fr-next','mg-next','ss-next','wm-next','br-next','us-next'].forEach(function(id){
