...
**Still open, in order:**
0. **The re-verification above**: 412, 375 and 320 overflow sweeps DONE and fixed (two rows in §3, nine pages, all clean at all three widths). Next: the em dash sweep across player copy, then the long tail at row 61.
