...
**Still open, in order:**
0. **The re-verification above**: 412 and 375 overflow sweeps DONE and fixed (row in §3); the 320 sweep result goes in its own row; then the em dash sweep across player copy.
