...
5. The long tail: 900 CSS jobs and 747 art files named per game in the two DETAIL files. Five
   ...
   the 3.4 MB button, and the impact-5 natives and satellites down to row 24 of the ranked table.
   Next is row 25 on, same method: read the game's CSS to do list, shoot before, patch, shoot after,
