...
| `plans/marrowdeep/proto/engine.js`, `sim.mjs`, `PROTO-REPORT.md` | The prototype engine, its harness and the tuning pass, finished and green: 481 assertions, the corrected master table reproduced, a 36 cell grid over 630,000 quests, and `--depths`, the winnability law, RED on purpose because its failure is the measured answer to Director call 1. Read section 8 of the report first. P0 step 0 still checks the state before anything is pasted. |
