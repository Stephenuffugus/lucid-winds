# QUEST COMPATIBILITY — 183 titles triaged
...
|---|---|---|
| ok | 160 | nothing found that stops a controller pointer |
| caution | 7 | playable, worth an eye on the device |
| blocked | 0 | needs a keyboard, two fingers, or device tilt |
| unknown | 16 | source not readable from this repo (external repos) |
