/* Brand the packaged exe: Jimothy's icon + version strings, in pure Node.
   ...
   Usage: node tools/brand_exe.mjs "<dist>/win-unpacked/Flock the World.exe" capsules/out/ftw.ico
...
vi.setStringValues({ lang: 1033, codepage: 1200 }, {
  FileDescription: 'Flock the World', ProductName: 'Flock the World', CompanyName: 'Sky Wolf Studio',
  LegalCopyright: 'Copyright 2026 Sky Wolf Studio', InternalName: 'Flock the World', OriginalFilename: 'Flock the World.exe', FileVersion: '1.0.0', ProductVersion: '1.0.0' });
