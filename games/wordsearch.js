...
function GW(a){var SZ=10,grid=[],words=[],found=[],sel=[];
  ...
  window._WN=function(){sel=[];found=[];gen();document.getElementById('Wf').textContent='0';document.getElementById('Wt').textContent=words.length;sm('');rn()};_WN();}
