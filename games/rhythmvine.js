...
window._gameFns.rhythmvine=function RV(a){
  ...
  css.textContent=''
    ...
    +'.RVlane{position:absolute;top:0;bottom:0;border-left:1px solid rgba(122,179,86,0.16);border-right:1px solid rgba(122,179,86,0.16);}'
    ...
    +'#RVhitline{position:absolute;left:0;right:0;bottom:14%;height:5px;background:linear-gradient(90deg,transparent,rgba(200,168,75,0.9),transparent);box-shadow:0 0 18px rgba(200,168,75,0.65),0 8px 0 rgba(122,179,86,0.4);z-index:4;pointer-events:none;}'
    ...
    +'#RVstart .s{font-family:DM Mono,monospace;font-size:0.7rem;color:var(--muted);max-width:300px;text-align:center;line-height:1.7;}'
