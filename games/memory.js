...
'<img src="assets/games/memory/18-night-blooming-cereus-card.png" alt="Night Cereus" style="width:92%;height:92%;object-fit:contain;border-radius:6px;">'
  ...
  function _mKill(){var o=document.getElementById('M-over');if(o)o.remove();}
  _mKill();  // a stale overlay from a previous mount must never sit over a fresh board
  if(window._lwRegisterGameCleanup)window._lwRegisterGameCleanup(_mKill);
