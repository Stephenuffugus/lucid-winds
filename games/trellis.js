  ...
  function endGame(){
    ...
    (function(pw,as2,wn,g){setTimeout(function(){
      ...
      ov.innerHTML='<div style="font-size:3rem;line-height:1;">'+(wn?'\ud83c\udfc6':'\ud83c\udf42')+'</div>'
        +'<div style="font-size:1.7rem;font-weight:700;color:'+(wn?'#7ab356':'#c78a50')+';letter-spacing:0.08em;margin-top:12px;">'+(wn?'YOU WIN THE TRELLIS':(pw===as2?'A DRAW':'THE COMPUTER TAKES IT'))+'</div>'
        +'<div style="font-size:1rem;color:#e8dcc8;margin-top:10px;">You <b style="color:#c8a84b">'+pw+'</b> \u00b7 Computer <b style="color:#c8a84b">'+as2+'</b></div>'
