/* The one command that says whether Swell is shippable.
 *
 ...
 * nobody has watched fail is decoration (HANDOFF-SWELL section 5).
 *
...
const GATES = [
  ...
  { name: 'theory', cmd: ['sim.js', '--test'], need: 'SWELL TEST OK' }
];
