 ...
 */
import { parseConfig, rng, sessionStep, tokens } from '../../math/core/core.js?v=20260915i';
import { generateSet, evaluate, isStandardLayout } from '../engine.js?v=20260915i';
import { COPY, PALETTE } from '../content.js?v=20260915i';
import { SCREEN_SCHEMA } from '../config.js?v=20260915i';
...
if ('serviceWorker' in navigator) navigator.serviceWorker.register('../sw.js?v=20260915i', { scope: '../' }).catch(() => {});
