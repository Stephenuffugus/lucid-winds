 ...
 */
import { settings, store, tokens, audio, SETTINGS_DEFAULTS, parseConfig, rng, collectOnce } from '../math/core/core.js?v=20260915i';
import { generateSet, evaluate, valueOf } from './engine.js?v=20260915i';
import { COPY, PALETTE } from './content.js?v=20260915i';
import { SPAN_SCHEMA } from './config.js?v=20260915i';
...
if ('serviceWorker' in navigator) navigator.serviceWorker.register('./sw.js?v=20260915i').catch(() => {});
