/* The one command that says whether GAUGE is shippable.
 *
 *   node tools/check.js            everything
 *   node tools/check.js --fast     skips the slow gates and SAYS so
 *
 * Shape copied from satellites/tint/tools/check.js: fast mode SKIPS a slow gate and never shrinks it; a failure prints
...
const GATES = [
  ...
  { name: 'decimal', cmd: ['test/decimal.mjs'], need: 'DECIMAL OK' },
