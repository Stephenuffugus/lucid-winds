...
const CACHE='blockspace-20260905d';
const SHELL=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./lib/three.module.min.js?v=20260905d'];
