/* The one command that says whether HUSH is shippable.
 *
 *   node tools/check.js            everything
 *   node tools/check.js --fast     skips the slow gates and SAYS so
 *
 * Shape copied from satellites/glimpse/tools/check.js: fast mode SKIPS a slow gate and never shrinks it; a failure prints
