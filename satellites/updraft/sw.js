/* UPDRAFT service worker — offline shell, single app file.

   Host law (learned the hard way across this fleet):
   - caches.keys() is ORIGIN-wide. Only ever delete updraft-* caches, or
...
const SHELL_VERSION = "updraft-shell-20260906e";
const SFX_CACHE     = "updraft-unused-v1"; // no recorded audio: every sound is synthesised
    ...
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(k =>
          ...
          k.indexOf("updraft-") === 0 && k !== SHELL_VERSION && k !== SFX_CACHE
...
function offlineFallback() {
  return new Response(
    ...
    "<body style='background:#8CC6F0;color:#20303a;font-family:system-ui;display:flex;align-items:center;" +
    "justify-content:center;height:100vh;margin:0;text-align:center'><div><h1 style='color:#E0503A'>UPDRAFT</h1>" +
    "<p>Cannot reach the field right now.<br>Check your connection and reload.</p></div></body>",
