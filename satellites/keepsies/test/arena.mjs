...
import * as A from '../src/core/rules-arena.js?v=20260904b';
import * as D from '../src/core/damage.js?v=20260904b';
import { bodySpec } from '../src/core/marbleBody.js?v=20260904b';
...
console.log('');
const P = await import('../src/core/physics.js?v=20260904b');
await P.initPhysics();
const { createArena } = await import('../src/game/arena.js?v=20260904b');
