...
const SAVE = await import(${JSON.stringify(join(ROOT, 'src/meta/save.js'))} + '?v=20260904a');
const R = await import(${JSON.stringify(join(ROOT, 'src/meta/ransom.js'))} + '?v=20260904a');
