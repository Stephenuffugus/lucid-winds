/* WARDIAN service worker — offline shell, single app file.

   Host law (learned the hard way across this fleet):
   - caches.keys() is ORIGIN-wide. Only ever delete wardian-* caches, or
...
const SHELL_VERSION = "wardian-shell-20260905a";
const SFX_CACHE     = "wardian-unused-v1"; // no recorded audio: every sound is synthesised
    ...
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(k =>
          ...
          k.indexOf("wardian-") === 0 && k !== SHELL_VERSION && k !== SFX_CACHE
...
function offlineFallback() {
  return new Response(
    ...
    "justify-content:center;height:100vh;margin:0;text-align:center'><div><h1 style='color:#E8C97A'>WARDIAN</h1>" +
