/* BLACKOUT service worker — offline shell, single app file.

   Host law (learned the hard way across this fleet):
   - caches.keys() is ORIGIN-wide. Only ever delete blackout-* caches, or this
     worker wipes PadLab and every other satellite on lucidwinds.com.
    ...
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(k =>
          ...
          k.indexOf("blackout-") === 0 && k !== SHELL_VERSION && k !== ASSET_CACHE
...
function offlineFallback() {
  return new Response(
    ...
    "<body style='background:#0a0b0f;color:#d8dde6;font-family:system-ui;display:flex;align-items:center;" +
    "justify-content:center;height:100vh;margin:0;text-align:center'><div><h1 style='color:#5ad1e6'>BLACKOUT</h1>" +
    "<p>The case file is out of reach right now.<br>Check your connection and reload.</p></div></body>",
