/* YONDER service worker: the offline shell (plans/yonder/HANDOFF-YONDER.md P3; CATALOG-PLAN D2; SPAN's sw.js, whose shape
   and scars this copies).

   The fleet's host law, learned the hard way:
   - caches.keys() is origin wide: only yonder- caches are ever deleted, or this worker wipes every other game.
...
const SHELL_VERSION = 'yonder-shell-20260915c';
...
const SHELL_ASSETS = [
  ...
  './index.html',
  './main.js?v=20260915c',
  './engine.js?v=20260915c',
  './content.js?v=20260915c',
  './config.js?v=20260915c',
  './race.js?v=20260915c',
  './map.js?v=20260915c',
  './draw.js?v=20260915c',
  './sprites.js?v=20260915c',
  './manifest.webmanifest?v=20260915c',
  './icon-192.png',
  './icon-512.png',
  './icon-maskable-512.png',
  '../math/core/core.css?v=20260915c',
  '../math/core/core.js?v=20260915c',
...
self.addEventListener('activate', event => {
  event.waitUntil(
    caches.keys()
      .then(keys => Promise.all(keys.filter(k => k.indexOf('yonder-') === 0 && k !== SHELL_VERSION).map(k => caches.delete(k))))
...
function offlinePage() {
  return new Response(
    ...
    + '<body style="margin:0;height:100vh;display:flex;align-items:center;justify-content:center;background:#f1e9d8;'
    + 'color:#2a2722;font-family:system-ui,sans-serif;text-align:center"><p>Yonder needs one visit with the internet first.</p></body>',
