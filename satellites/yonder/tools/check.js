/* The one command that says whether YONDER is shippable.
 *
 ...
 * PASSED. An ES module, because satellites/yonder/package.json says "type": "module" so Node reads engine.js as one.
 * Browser gates are run in the foreground, one per call, on this box (plans/yonder/HANDOFF-YONDER.md 0.4).
 */
