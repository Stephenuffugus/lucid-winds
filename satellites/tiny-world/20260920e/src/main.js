...
gestures = createGestures({
  ...
  onPoke: (h) => { counts.mark('poked'); const e = ent(sim.w, h); if (e >= 0) audio.chirp(sim.w.C.S[sim.w.E.kind[e]], sim.w.E.x[e], sim.w.E.y[e]); },
});
...
if (Q.has('debug')) window.__tw = { get sim() { return sim; }, get speed() { return speed; }, get paused() { return paused; }, get broken() { return broken; }, errors, cam, renderer, saver, get store() { return store; }, audio, ui, because, counts, get scrap() { return scrap; } };
