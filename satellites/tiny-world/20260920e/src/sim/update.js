...
import { log, ref, markDirty, tileOf, struct, flies, swims, inWater, reach, dist, isNight } from './world.js';
import { spawn, ent, compact, HELD, G_MOVE, G_ATTACK, G_ABDUCT, G_GRAZE, G_BUSH, G_HOUSE, G_MATE, G_JOIN, G_FETCH, G_STORE, G_BUILD } from './ents.js';
...
import { allowed, effect, SRC, WARN, NONE } from './harm.js';
...
function hazards(w, e, t, wet) {
  ...
  const lava = t === w.C.tid.lava && !br && !sp.lavaProof, drown = wet && !sp.water && !swims(w, e), dry = sp.water && !wet;
