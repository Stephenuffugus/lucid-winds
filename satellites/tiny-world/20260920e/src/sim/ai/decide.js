...
import { reach, dist, isNight, struct } from '../world.js';
import { nearest, nearestHuman, findStruct, findGrass } from '../query.js';
import { hunts, huntsKind, armed, balk } from '../combat.js';
import { ent, goalMove, goalEnt, G_MOVE, G_ATTACK, G_ABDUCT, G_GRAZE, G_BUSH, G_HOUSE, G_MATE, G_JOIN, G_FETCH, G_STORE, G_BUILD } from '../ents.js';
...
function see(w, e, b) {
  ...
  else if (b === P_ARMED) v = noHunters(w, e) ? none(w, e, A.armedScan, fHuntsMe) : nearest(w, e, A.armedScan, fHuntsMe);
