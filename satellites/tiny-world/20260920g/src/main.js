...
const ui = { held: null, pokes: new Map(), outlines: new Map(), follow: 0, now: 0, spark: null, why: new Map(), pouring: false, pour: null, pourAt: null, U: data.ui };
...
for (const [id, k] of Object.entries(soundBs)) document.getElementById(id).onclick = () => { audio.unlock(); audio.set(k, !audio.settings[k]); showSound();
...
function useSim(s, view) {
  ...
  ui.held = null; ui.follow = 0; ui.pokes.clear(); ui.outlines.clear(); ui.why.clear(); hidePicker(); because.clear(); doll.hide(); news.clear();
