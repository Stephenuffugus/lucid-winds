...
import { reach, dist, isNight, struct, removeStruct, inB, hiddenIn, terrAt, speciesCapOf, asleep, wake } from '../world.js';
...
const BEHAVIOURS = [
  ...
  { id: B_MATE, max: 30, // fed, healthy adults ready to breed, under both caps
    score(w, e) {
      ...
      if (!(see(w, e, P_MATE) >= 0 && w.count < B.popCap && w.kindCount[w.C.kid[kind]] < speciesCapOf(w))) return false;
