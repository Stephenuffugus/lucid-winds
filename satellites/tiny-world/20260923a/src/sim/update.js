...
import { log, ref, markDirty, tileOf, struct, flies, swims, inWater, reach, dist, isNight, removeStruct, onFlowers, setTerrain, speciesCapOf, placeStruct, wake, favourite, SLEEP_DAWN, SLEEP_DUSK } from './world.js';
...
const roomToHatch = (w, s) => growsInto(w, s) !== null || (w.count < w.R.breed.popCap && w.kindCount[w.C.kid[hatchKind(w, s)]] < Math.min(w.R.react.layCap, speciesCapOf(w)));
