...
export const POWER_EV = { bolt: 'bolt', fireball: 'boom', meteor: 'boom', twister: 'magic', freeze: 'freeze', heal: 'heal', bless: 'bless', clone: 'magic', love: 'magic', rain: 'rain', feast: 'feast', time: 'time', quake: 'quake', smite: 'bolt', gust: 'chute', bubbles: 'chute', bloom: 'heal', growbig: 'magic' };
const CAP = 256;
