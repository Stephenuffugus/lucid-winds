...
export function createDoll({ data, getSim, command = () => {}, now = () => performance.now() }) {
  ...
  const nameB = el.querySelector('button'), sheet = document.getElementById('namesheet');
