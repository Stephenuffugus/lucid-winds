...
// pathFresh, 1 once it has had a path for pathGoal (so asking again means searching again).
export const FIELDS = ['id', 'kind', 'x', 'y', 'px', 'py', 'hp', 'hunger', 'gear', 'face', 'think', 'cd', 'breedCd', 'born', 'baby',
  ...
  'blockT', 'pathN', 'pathI', 'pathGoal', 'pathQd', 'pathAt', 'pathFresh'];
...
const TYPES = { face: Int8Array, baby: Uint8Array, dead: Uint8Array, chute: Uint8Array, bounced: Uint8Array, goalKind: Uint8Array,
  ...
  blockT: Uint8Array, pathN: Uint8Array, pathI: Uint8Array, pathGoal: Int32Array, pathQd: Uint8Array, pathAt: Int32Array, pathFresh: Uint8Array };
...
export function goalEnt(w, i, kind, o) { const E = w.E; E.goalKind[i] = kind; E.goalA[i] = w.slotH[o]; E.goalB[i] = w.C.kid[E.kind[o]]; }
...
export function spawn(w, kind, x, y, baby) {
  ...
  E.blockT[s] = 0; E.pathN[s] = 0; E.pathI[s] = 0; E.pathGoal[s] = 0; E.pathQd[s] = 0; E.pathAt[s] = 0; E.pathFresh[s] = 0;
