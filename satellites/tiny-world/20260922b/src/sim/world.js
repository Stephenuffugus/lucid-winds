...
export function createWorld(C, { cols, rows, seed, settings }) {
  ...
  const w = {
    ...
    vg: { flag: 0, store: 0, next: 0, worker: 0, site: -1, cd: 0, age: 0, told: -1, said: 0, since: 0, founding: 0, quit: 0, lostTo: 0, lostWet: 0, learned: 0, idle: 0, posted: 0, near: 1e9 },
...
export function resetWorld(w) {
  ...
  w.claim.fill(0); w.claimN = 0; w.vg = { flag: 0, store: 0, next: 0, worker: 0, site: -1, cd: 0, age: 0, told: -1, said: 0, since: 0, founding: 0, quit: 0, lostTo: 0, lostWet: 0, learned: 0, idle: 0, posted: 0, near: 1e9 };
