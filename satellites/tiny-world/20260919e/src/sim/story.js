...
export const ST = ['birth', 'death', 'zombie', 'abducted', 'rescued', 'returned', 'landed', 'fled', 'hungry', 'shelter', 'love'];
...
export function readStory(w, i) {
  ...
  return { kind: ST[s.kind[i]], place: [s.x[i], s.y[i]], actors, causeA: s.ca[i], causeB: s.cb[i], result: s.res[i], say: s.say[i] };
}
