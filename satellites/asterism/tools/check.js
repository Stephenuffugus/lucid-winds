/* The one command that says whether Asterism is shippable.
 *
 ...
 * nobody has watched fail is decoration (HANDOFF-ASTERISM section 5).
 *
...
const BROWSER_GATES = [
  ...
  { name: 'sky',    cmd: ['test/sky.mjs'],    need: 'SKY OK' },
  { name: 'planets', cmd: ['test/planets.mjs'], need: 'PLANETS OK' },
