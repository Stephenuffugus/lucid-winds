 ...
 * MINUTE into an OfflineAudioContext through the same start, chime, close,
 * scratch and swell the speaker uses, air tone and all, and hands back three
 * numbers:
 *
...
/* 1. NOTHING CLIPS. Measured 0.372 on the loudest minute the code can arrange:
   ...
   air tone the whole app sits in. 0.369 on Sep 08 with the close voice in the
   schedule as well, a two note chime every second and a half, which is faster
   than three taps can be landed. Nobody draws that fast. The ceiling is 0.90
   ...
   next envelope that starts after the oscillator it is supposed to shape: on
   Sep 08 the close voice's second note was started at t0 with its envelope 90
   ms later, as a planted mutation, and this read 1.200 and went red. */
...
/* 2. THE LEVEL. Measured rms 0.0491, 0.0545 with the close voice. The band is
   0.010 to 0.12. The floor says
...
/* 3. NOT AN ALARM. Measured 0.35 percent of the minute's energy above 3 kHz,
   0.39 with the close voice. This sky is a 340 Hz low passed air tone, a chime
   between 330 and 880, a close that adds the fifth above it (to 1320 at most),
   a 2 kHz bandpassed scratch and a swell at 110 to 220: it belongs below 3 kHz,
