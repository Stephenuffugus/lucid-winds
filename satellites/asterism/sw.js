/* ASTERISM service worker — offline shell, single app file.

   Host law (learned the hard way across this fleet):
   - caches.keys() is ORIGIN-wide. Only ever delete asterism-* caches, or
...
const SHELL_VERSION = "asterism-shell-20260905a";
...
const SHELL_ASSETS = [
  ...
  "./data/hyg-asterism.json?v=20260905a"
];
    ...
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(k =>
          ...
          k.indexOf("asterism-") === 0 && k !== SHELL_VERSION && k !== SFX_CACHE
...
function offlineFallback() {
  return new Response(
    ...
    "justify-content:center;height:100vh;margin:0;text-align:center'><div><h1 style='color:#E8C97A'>ASTERISM</h1>" +
    "<p>Cannot reach the sky right now.<br>Check your connection and reload.</p></div></body>",
