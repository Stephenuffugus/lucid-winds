/* Siege of One service worker — offline shell, single app file.

   Host law (learned the hard way across this fleet):
   - caches.keys() is ORIGIN-wide. Only ever delete siege-* caches, or
...
const SHELL_VERSION = "siege-shell-v10";
    ...
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(k =>
          ...
          k.indexOf("siege-") === 0 && k !== SHELL_VERSION
...
function offlineFallback() {
  return new Response(
    ...
    "justify-content:center;height:100vh;margin:0;text-align:center'><div><h1 style='color:#e8703a'>Siege of One</h1>" +
    "<p>Cannot reach the siege right now.<br>Check your connection and reload.</p></div></body>",
