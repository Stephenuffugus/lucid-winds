/* The one command that says whether BRIM is shippable.
 *
 ...
 * PASSED. Browser gates join BROWSER_GATES as each phase writes them.
 */
...
const GATES = [
  ...
  { name: 'pairs', cmd: ['test/pairs.mjs'], need: 'PAIRS OK' },
