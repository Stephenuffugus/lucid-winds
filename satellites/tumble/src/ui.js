...
const I = {
  ...
  shelf: '<svg viewBox="0 0 40 40"><rect x="3" y="28" width="34" height="4.4" rx="1.8" fill="#b08a5c"/><path d="M8 32.4v4.6M32 32.4v4.6" stroke="#b08a5c" stroke-width="3" stroke-linecap="round"/><path d="M9 12h12v16H9z" fill="#e7f0f4" fill-opacity=".85" stroke="#7f95a1" stroke-width="2.4"/><rect x="8" y="9" width="14" height="3.4" rx="1.2" fill="#c9a86e"/><circle cx="15" cy="22.5" r="4.2" fill="#c07c4e"/><path d="M24 28a7 7 0 0 1 13 0z" fill="#f1e6d2" stroke="#b09a78" stroke-width="2.2"/><circle cx="30.5" cy="24.2" r="2.8" fill="#5c8fbe"/></svg>',
