/* The one command that says whether Whistlestop is shippable.
 *
 ...
 * nobody has watched fail is decoration (HANDOFF-WHISTLESTOP section 5).
 *
...
/* CommonJS on purpose. This file is named check.js because the plan and every
   ...
   Nothing in the sim gate may be weakened to go green: a loop that does not
   close and a car that drifts through a curve are the two ways this game
   stops being a train set. */
...
const BROWSER_GATES = [
  ...
  { name: 'build', cmd: ['test/build.mjs'], need: 'BUILD OK' },
