  ...
  async (req, res) => {
    try {
      ...
      let h = '<!doctype html><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
        ...
        + '<b>new-direct</b> is a first ever visit with no referring site, which is where the QR stickers land. '
        + '<b>app</b> is the installed home screen app (your own opens live there). '
        + '<b>lw-</b> columns are the same buckets for the game front door at lucidwinds.com.</p>'
