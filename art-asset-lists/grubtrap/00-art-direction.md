...
# SKINS EXPANSION (added 7/17 — Stephen: themed skins people can unlock)

Sheets 01-04 with a slug in the filename (snowday/tidepool/lanternnight/clockwork) are SKIN sheets; the two original sheets above are the base-game art. Skin sheets use the papercraft style baked into their own files.
