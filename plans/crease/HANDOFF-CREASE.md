...
- SHOT p3-shelf-412x915.png OPENED. Faults: (1) the folded paper boat sits in the top left corner of the board at the fourth width as at the other three; (2) the board is a flat brown slab with no shelf edge, no depth and no place marks to say more will come; (3) the boat is the only object on a 915 px screen, with roughly 600 px of empty page above the board; (4) board brown and page cream are close enough in value that the board reads as a panel rather than a shelf.
- SHOT p1-reveal-412x915.png OPENED. Faults: (1) two grips, blue and orange, stand apart on the strip with nothing saying which is the child’s placement and which the true one, the same unexplained pair the catalog keeps repeating; (2) the stretch between 0 and the blue grip is filled with diagonal hatching that matches nothing else in the game and reads as damage rather than as a measured length; (3) the 3/8 caption sits under the 0 end of the strip, far from the mark it names; (4) the reveal looks identical to play but for the second grip, so nothing says the round is over or whether the placement was right.
- SHOT p1-build-320x568.png OPENED. Faults: (1) the strip carries no divisions at all under a three eighths ask, which is right for the build state but means the first screen offers nothing to count; (2) the grip sits ON the 0 post, covering the end the measurement starts from; (3) nothing in this state can be pressed and no words appear, so a child has no way in; (4) the board is a flat brown slab holding one thin bar with the bottom third empty.
- SHOT p1-drag-412x915.png OPENED. Faults: (1) a two celled card with a blue line through it sits at the top of the board with nothing saying what it is or how it relates to the strip beneath; (2) the grip hangs in mid air between that card and the strip, touching neither, so nothing shows what is being dragged or to where; (3) the strip is a plain cream bar with ends 0 and 3 and no cells, so a three eighths ask has nothing to land on in this state; (4) no words appear anywhere and the bottom half of a 915 px screen is empty.
- SHOT p1-build-1366x768.png OPENED. Faults: (1) the board is a 640 px slab on a 1366 px screen holding one thin undivided bar, with about 360 px bare on each flank and 330 px below; (2) the grip sits ON the 0 post, covering the end the measurement starts from; (3) nothing in this state can be pressed and no words appear anywhere; (4) the strip runs almost the full width of the board while the board itself is half the screen, so the one object is both stranded and stretched.
- SHOT p1-reveal-320x568.png OPENED. Faults: (1) two grips, blue and orange, stand close together with nothing saying which is the child’s and which the true one; (2) the hatched stretch between them matches nothing else in the game and reads as damage; (3) the 3/8 caption sits under the 0 end, away from the mark it names; (4) at 320 the cells of the creased strip are about 10 px wide, so the parts a child is meant to count read as a barcode.
- SHOT p1-first-1366x768.png OPENED. Faults: (1) the first screen a child meets on a laptop is a 260 px brown box holding one small cream bar, adrift in the middle of a 1366 by 768 page with roughly 550 px bare on each flank; (2) no numbers, no grip, no ask and no words anywhere, so nothing says what this is or what to do; (3) the single tray button below shows a tiny strip with a grip, a picture of the thing missing from the board above it; (4) the bottom 60 per cent of the screen is empty.
- SHOT p1-reveal-1366x768.png OPENED, and it speaks to the count question I have been deferring all night: at this width the creased strip’s cells are countable and there appear to be TWENTY FOUR of them between 0 and 3, with bold marks at 1 and 2 — which is exactly whole (3) times denominator (8), the number main.js asks foldTo for. So the engine looks right and the twelve I counted at 375 was very likely a mid fold or my miscount at a smaller size. Recorded as supporting evidence, NOT as proof: the count law on twenty seeds is still the thing that should settle it, and I have been wrong from pictures often enough tonight to say so. Faults that stand: (1) two grips, blue and orange, with nothing saying which is the child’s and which the true one; (2) the hatched stretch between them matches nothing else in the game and reads as damage; (3) the 3/8 caption sits under the 0 end, away from the mark it names; (4) the board is 640 px on a 1366 px screen with the bottom 45 per cent empty.
- SHOT p1-drag-320x568.png OPENED. Faults: (1) a two celled card with a blue line through it sits at the top of the board with nothing saying what it is or how it relates to the strip below; (2) the grip hangs in mid air between that card and the strip, touching neither, so nothing shows what is dragged or to where; (3) the strip is a plain cream bar with ends 0 and 3 and no cells, so the three eighths ask has nothing to land on in this state; (4) no words anywhere and the bottom third empty.
- SHOT SWEEP COMPLETE for this pass: every P3 state of all seven games has now been opened at 320, 375, 412 and 1366, along with CREASE’s P1 states, and three faults are named for each in these ledgers. The repeats worth one decision each, rather than seven: the first earned thing sits in the TOP LEFT CORNER of an empty board (NOTCH, GAUGE, GLIMPSE, BRIM, CREASE, not HUSH); reveals mark the child’s choice and the true answer with ONE mark everywhere except NOTCH’s find reveal and GAUGE’s compare reveal; four of seven games have WORDLESS doors (only GAUGE and TINT name what a child is choosing); NOTCH shows the browser’s blue focus ring on five screens; HUSH clips its creature on the panel edge in five screens at every width; CORE’s settings gear sits 8 px from the right edge in every game.
