...
**Not gated, and it should be:** the lever glyph floor (`CONFIG.LEVER_MIN_PX`)
is a rendering change with no assertion behind it. The gate it wants measures
the canvas, not the formula it came from.
