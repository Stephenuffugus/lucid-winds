...
**HIS STEPS:** upload r8 (Standard, then the build click), set live on default, Exit/reopen Steam, title must say v9.3, look at the title menu and the Prize Bin, then wiggle the mouse on Settings.
